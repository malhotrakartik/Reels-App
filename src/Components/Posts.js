    ...
    const[posts,setPosts] = useState(null);
      ...
      useEffect(()=>{
        ...
        const unsub = database.posts.orderBy('createdAt','desc').onSnapshot(querySnapshot=>{
          parr=[];                                                                      //redundancy htane k liye(kyun ki snapshot har baari posts update hone pr chlega)
      ...
      useEffect(()=>{
        ...
        return ()=>{                     //posts upadate hone pr observer dobara connect hoga to pichla hata do
          observer.disconnect();
        }
      },[posts])
      return (
